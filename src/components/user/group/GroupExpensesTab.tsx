...
interface GroupExpensesTabProps {
    ...
    isDark: boolean;
    onExpensePress?: (expense: ExpenseDetailsBasicResponse) => void;
}

export const GroupExpensesTab = ({ expenses, isDark, onExpensePress }: GroupExpensesTabProps) => {
