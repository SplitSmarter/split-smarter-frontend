    ...
    theme: {
        extend: {
            ...
            colors: {
                ...
                // --- Accent / Interactive Highlights (ADDED MISSING HERE) ---
                'accent-sky': "rgb(var(--color-accent-sky) / <alpha-value>)",
                'accent-sky-bg': "rgb(var(--color-accent-sky-bg) / <alpha-value>)",
                'orb-indigo': "rgb(var(--color-orb-indigo) / <alpha-value>)",
                ...
                'text-overlay': "rgb(var(--color-text-overlay) / <alpha-value>)",
